...
Raw_images_directories_addresses = list(
    paths.list_images('Trainfiles/preprocessed_images_CascadeClassifier_Medianblur'))
...
print(np.shape(images_parameters))
...
Preprossesd_images_directories_addresses = list(
    paths.list_images('Trainfiles/preprocessed_images_CascadeClassifier_Medianblur'))
...
while True:
    ...
    model = svm.SVC(kernel='rbf', C=1000, cache_size=10000)
